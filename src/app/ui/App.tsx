...
export default function App() {
  return (
    <div className="flex items-center justify-center w-full min-h-[100dvh] bg-black">
      {/* 가변적으로 화면을 채우는 메인 컨테이너 (iPhone 15 Pro 등 지원) */}
      <div className="relative w-full h-[100dvh] max-w-[430px] mx-auto bg-gray-900 shadow-[0_0_15px_rgba(0,0,0,0.5)] flex flex-col overflow-hidden">
        ...
        <div className="flex-1 w-full bg-[#1a1a2e] flex items-center justify-center relative">
          <PhaserGame />
        </div>
